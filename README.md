...
## Environments
- Preview: https://main--lesmills2--wfranksadobe.aem.page/
- Live: https://main--lesmills2--wfranksadobe.aem.live/
...
1. Open the `lesmills2` directory in your favorite IDE and start coding :)
